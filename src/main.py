                ...
                <div class="col-4">
                    <div class="card">
                        <div class="row mt-2">
                            <form>
                                <div class="col-12">
                                    <input type="text" placeholder="Имя" class="form-control" id="exampleInputName1">
                                </div>
                                <div class="col-12">
        ...
        <div class="container">
            <div class="row">
                <div class="row text-center">
                    ...
                    <div class="col-4">
                        <button class="w-100 btn btn-sm btn-primary" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                            <div class="card card-body">
                                Нажми "Купить", а там разберешься.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-4">
                        ...
                        <div class="collapse multi-collapse" id="multiCollapseExample2">
                            <div class="card card-body">
                                Варианты доставки: курьером, почтой, дроном.
                            </div>
                        </div>
                    </div>
